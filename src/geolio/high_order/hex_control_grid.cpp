...
namespace geolio
{
    ...
    GEO::vec3 HexControlGrid::compute_cell_uvw_position(
        const GEO::index_t c,
        const GEO::vec3& uvw
        ) const {
    ...
    [[nodiscard]] GEO::vec3 HexControlGrid::compute_cell_uvw_position(
        const GEO::index_t c,
        const GEO::vec3& uvw,
    ...
    GEO::vec3 HexControlGrid::compute_cell_facet_uv_normal(
        const GEO::index_t c,
    ...
    void HexControlGrid::compute_cell_uvw_dudvdw(
        const GEO::index_t c,
        const GEO::vec3& uvw,
        GEO::vec3& du,
        GEO::vec3& dv,
    ...
    double HexControlGrid::compute_cell_uvw_quantity(
        const GEO::index_t c,
        const GEO::vec3& uvw,
        const GEO::index_t d
        ) const {
    ...
    void HexControlGrid::compute_cell_uvw_quantities(
        const GEO::index_t c,
        const GEO::vec3& uvw,
        double* q
        ) const {
