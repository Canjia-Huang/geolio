...
namespace geolio
{
     ...
     *  - what is decided on generated points is decided *combinatorially*, never by testing
     *    the geometry of the result: how the two halves of a 2/2 configuration are connected
     *    follows from the parity of the vertex selection (see
     *    AxisAlignedTetClipper::clip()), which is exact and cannot decorrelate, unlike the
     *    sign of the volume of a cell, which is decided by the rounding of the intersection
     *    points as soon as the section is thin;
     ...
     *
     * @note Assumes IEEE-754 double arithmetic (no `-ffast-math`, no flush-to-zero mode): the
     *  exactness of the classification and the exact degeneracy of the cells generated by a cut
     *  through a vertex both rest on it.
     */
